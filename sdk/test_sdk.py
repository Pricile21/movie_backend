# %%
from moviessdk_Pricile import movies_client, movies_config


# Initialisation du client avec l'URL de l'API
config = movies_config.MovieConfig(movie_base_url="https://movie-backend-fdte.onrender.com")
client = movies_client.MovieClient(config=config)
